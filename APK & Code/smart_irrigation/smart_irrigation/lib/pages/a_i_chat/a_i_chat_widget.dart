...
class _AIChatWidgetState extends State<AIChatWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'AI_Chat'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('A_I_CHAT_arrow_back_rounded_ICN_ON_TAP');
              ...
              children: [
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('A_I_CHAT_PAGE_SEND_BTN_ON_TAP');
                      logFirebaseEvent('Button_gemini');
                      await geminiGenerateText(
                        context,
                        _model.textController.text,
                      ).then((generatedText) {
                        safeSetState(() => _model.answer = generatedText);
                      });
