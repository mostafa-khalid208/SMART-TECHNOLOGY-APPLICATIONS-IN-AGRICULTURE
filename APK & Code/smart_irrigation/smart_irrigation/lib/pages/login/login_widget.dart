                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'kj48qb1q' /* Use the account below to sign ... */,
                        ),
                        style:
                      ...
                      children: [
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'LOGIN_PAGE_Text_ueusjcf2_ON_TAP');
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'sd0t8vqm' /* I don't have an account */,
                                ),
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'LOGIN_PAGE_GUEST_ACCOUNT_BTN_ON_TAP');
                              logFirebaseEvent('Button_navigate_to');

                              context.pushNamedAuth(
                                  'Listofvegetables', context.mounted);
